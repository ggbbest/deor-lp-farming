...
/*
_GOVADDRESS: address
_CONTROLLERWALLET: address
_EARNEXECUTOR:address
_KLAYFARMADDRESS:address
_CEIKADDRESS:address
_ISAUTOCOMP:bool
_ISAUTOEXCHANGE:bool
_WANTADDRESS:address
_EARNEDADDRESS:address
_UNIROUTERADDRESS:address
_EARNEDTOCEIKPATH:address[]
_EARNEDTOTOKEN0PATH:address[]
_EARNEDTOTOKEN1PATH:address[]
_TOKEN0TOEARNEDPATH:address[]
_TOKEN1TOEARNEDPATH:address[]
...
contract KLAYSwapVault is Ownable, ReentrancyGuard, Pausable {
    ...
    address[] public earnedToCEIKPath;
    ...
    constructor(
        ...
        address _CEIKAddress,
        bool _isAutoComp,
        bool _isAutoExchange,
        address _wantAddress,
        address _earnedAddress,
        address _uniRouterAddress,
        address[] memory _earnedToCEIKPath,
        ...
        if (isAutoComp){
            ...
            earnedToCEIKPath = _earnedToCEIKPath;
    ...
    function buyBack(uint256 _earnedAmt) internal returns (uint256) {
        ...
        require(IKIP7(CEIKAddress).transfer(buyBackAddress, IKIP7(CEIKAddress).balanceOf(address(this))));
